    ...
    <div class="flex h-screen container mx-auto dark:bg-gray-900">
        ...
        <div class="flex sm:items-center justify-between py-3 border-b-2 border-gray-200">
            <div class="relative flex items-center space-x-4">
                ...
                <img src="https://mdbootstrap.com/img/new/avatars/2.jpg" alt="" class="w-10 sm:w-16 h-10 sm:h-16 rounded-full">
                </div>
                <div class="flex flex-col leading-tight">
                    <div class="text-2xl mt-1 flex items-center">
                    <span class="text-gray-700 mr-3">Roman Abramov</span>
                    </div>
                    <span class="text-lg text-gray-600">Middle Full Stack Developer</span>
                </div>
            </div>
